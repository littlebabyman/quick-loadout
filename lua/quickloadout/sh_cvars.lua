...
CreateConVar("quickloadout_giveclips", -1, {FCVAR_ARCHIVE + FCVAR_REPLICATED}, "Amount of clips worth of ammo a weapon gets upon applying a loadout. -1 uses weapon defaults instead.", -1)
