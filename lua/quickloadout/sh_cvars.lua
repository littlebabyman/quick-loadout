...
if CLIENT then
    ...
    CreateClientConVar("quickloadout_showcharacter_weapon", 1, true, false, "Show your player character wielding a weapon.")
    ...
    -- CreateClientConVar("quickloadout_ui_color_text", "255 255 255", true, false, "Base color used for loadout menu text.")
end